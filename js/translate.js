...
config(['$translateProvider', function ($translateProvider) {
    ...
    OVERVIEW_INFO_PRIV: 'WhatsApp gebruikers die hun last seen op "nobody" hebben staan ',
    ...
    OVERVIEW_INFO_TIMESPAN: 'Alles behalve de status tijdlijn is informatie vanaf het moment dat je die persoon begon te volgen.',
    ...
    TIMELINE_INFO_CONTINIOUS: '',
    TIMELINE_INFO_LASTSTATUS: 'WhatsApp gebruikers die hun last seen op "nobody" hebben staan ',
    ...
    TIMELINE_ACTIVITY_TIMESPAN1: 'Activity Tijdlijn',
    ...
    TIMELINE_ACTIVITY_PRIV_CONTACTSTITLE: 'Deze privacy instelling kan zowel op contacten of nobody staan, dit kan niet gedetecteerd worden.',
    ...
    ABOUT_LICENSE0: 'WhatsSpy Public is een Proof of Concept om aan te tonen hoe slecht het er voor staat met de privacy binnen WhatsApp. Met deze tool kan je iedereens gedrag op WhatsApp volgen met alleen de kennis over hun telefoonnummer. Deze tool is alleen voor Proof of Concept doeleinden! Lees asjeblieft de ',
