...
class Constants
{
    ...
    const WHATSAPP_VER = '2.16.31';                                                         // The WhatsApp version.
    ...
    const WHATSAPP_USER_AGENT = 'WhatsApp/2.16.31 Android/5.1.1 Device/OnePlus-A0001';        // User agent used in request/registration code.
