...
/**
  ...
  *		$rewriteSpaces fill a line with atleast x spaces if the msg is shorter than 55 chars.
  */
function tracker_log($msg, $date = true, $newline = true, $carriagereturn = true, $rewriteSpaces = 55) {
	if($date) {
